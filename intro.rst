...
.. note:: Users should carefully read the :ref:`design` and the :ref:`parameters_intro`, as well as the introductory parts of the sections :ref:`geometry`, :ref:`primary`, :ref:`physics` and :ref:`scoring`). The rest of the documentation provides a detailed reference that you may just want to skim initially.
